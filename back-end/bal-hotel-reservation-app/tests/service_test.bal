...
function testReservation() returns error? {
    ...
    ReservationRequest reservationRequest = {checkinDate: "2024-02-19T14:00:00Z", checkoutDate: "2024-02-20T10:00:00Z", rate: 100, user: {id: "123", name: "waruna", email: "warunaj@wso2.com", mobileNumber: "0094713255198"}, roomType: "Family"};
...
function testMultipleReservations() returns error? {
    ...
    foreach int i in 0 ... 2 {
        reservationRequest = {checkoutDate: "2024-02-20T10:00:00Z", rate: 100, checkinDate: "2024-02-19T14:00:00Z", user: {id: "123", name: "waruna", email: "warunaj@wso2.com", mobileNumber: "0094713255198"}, roomType: "Suite"};
