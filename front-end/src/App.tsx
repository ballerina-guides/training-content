...
export default function App() {
  ...
  const [user, setUser] = useState<User>({ email: '', id: '', name: '', mobileNumber: '' });
  ...
  const FakeLoginPage = () => {
    return (
      <div>
        <button onClick={() => {
          Cookies.set('userinfo', "");
          window.location.pathname = "/";
        }}>login-quickly</button>
      </div>
    );
  }
